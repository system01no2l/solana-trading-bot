...
export class Bot {
    ...
    public async buy(accountId: PublicKey, poolState: LiquidityStateV4) {
        const openPool = new Date().getTime();
        logger.trace(`Processing new pool... mint: ${poolState.baseMint} _ ${openPool}`);
        ...
        try {
            ...
            logger.trace(`Time buy: ${poolState.baseMint} _ ${timeBuy} _ ${openPool - timeBuy}ms`);
    ...
    public async sell(accountId: PublicKey, rawAccount: RawAccount) {
        if (this.config.maxTokensAtTheTime) {
